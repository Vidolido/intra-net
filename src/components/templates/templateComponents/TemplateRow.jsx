...
const TemplateRow = ({ item, templateId }) => {
	return (
		<div className='grid grid-cols-[25px_25%_1fr_1fr_1fr_1fr_1fr_25px] border border-t-0 border-slate-300'>
			...
			<p className='border-r border-slate-300 pl-2'>{item.result}</p>
			<p className='border-r border-slate-300 pl-2'>{item.marginError}</p>
			<div>
