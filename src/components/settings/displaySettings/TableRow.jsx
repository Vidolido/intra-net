  ...
  return (
    <Fragment>
      ...
      options[settingId].edit ? (
        <tr className='outline outline-slate-200 rounded outline-1'>
          <td colSpan={collections.length + 3} className='mb-1'>
      ...
      <tr className='outline outline-slate-200 rounded outline-1 hover:outline-red-500'>
