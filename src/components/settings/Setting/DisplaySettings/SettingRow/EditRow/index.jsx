...
const EditRow = ({
  ...
  const handleSubmit = async () => {
    console.log(state, 'the edit settings state');
    console.log(documentId, 'documentId');
    console.log(setting._id, 'setting._id');
    await editSetting(documentId, setting._id, state);
  };

  // const deleteCollectionItem = (e) => {
  //   console.log(state);
  // };

  return (
    <form className='border border-slate-200 bg-slate-100 rounded p-1 col-span-4 min-h-[200px]'>
