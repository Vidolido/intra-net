...
function filterByLink(arrayOfObjects, linkValues) {
  return arrayOfObjects.filter((obj) =>
    linkValues.some((link) => obj.links.includes(link))
  );
}
...
const SelectFields = ({
  ...
  const [fields, setFields] = useState(
    filterByLink(dbFields, [document.header.documentType, 'other'])
  );
  const handleHide = () => {
    setVisible(!visible);
  };
  ...
  //   console.log(document.header.documentType, 'the document');
  //   let test = filterByLink(fields, document.header.documentType);
  //   let test = fields.filter((field) =>
  //     field.links.includes(document.header.documentType)
  //   );
